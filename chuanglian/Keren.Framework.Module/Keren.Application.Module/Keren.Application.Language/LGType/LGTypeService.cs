    ...
    public class LGTypeService : RepositoryFactory
    {
        ...
        public IEnumerable<LGTypeEntity> GetList(string queryJson)
        {
            try
            {
                ...
                strSql.Append("SELECT ");
                strSql.Append(fieldSql);
                strSql.Append(" FROM KR_Lg_Type t WHERE 1=1 ");
                //参考写法
        ...
        public IEnumerable<LGTypeEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                ...
                strSql.Append("SELECT ");
                strSql.Append(fieldSql);
                strSql.Append(" FROM KR_Lg_Type t ");
        ...
        public void SaveEntity(string keyValue, LGTypeEntity entity)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(keyValue))
                {
                    ...
                    var sql = "UPDATE KR_Lg_Map SET F_TypeCode='" + entity.F_Code + "' WHERE F_TypeCode='" + oldentity.F_Code + "'";
                    db.ExecuteBySql(sql);
        ...
        public void SetMainLG(string keyValue)
        {
            ...
            try
            {
                string sql = "UPDATE KR_Lg_Type SET F_IsMain=0 WHERE F_IsMain=1";
                db.ExecuteBySql(sql);
                string sql1 = "UPDATE KR_Lg_Type SET F_IsMain=1 WHERE F_Id='" + keyValue + "'";
