    ...
    public class CodeSchemaService : RepositoryFactory
    {
        ...
        public IEnumerable<KR_Base_CodeSchemaEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                ...
                t.F_Description
                ");
                strSql.Append("  FROM KR_Base_CodeSchema t ");
                ...
                return this.BaseRepository().FindList<KR_Base_CodeSchemaEntity>(strSql.ToString(),dp, pagination);
            }
            catch (Exception ex)
            {
        ...
        public KR_Base_CodeSchemaEntity GetKR_Base_CodeSchemaEntity(string keyValue)
        {
            try
            {
                return this.BaseRepository().FindEntity<KR_Base_CodeSchemaEntity>(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public DataTable GetSqlTree()
        {
            try
            {
                return this.BaseRepository().FindTable(" select * from kr_base_dataitemdetail ");
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                this.BaseRepository().Delete<KR_Base_CodeSchemaEntity>(t=>t.F_Id == keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
