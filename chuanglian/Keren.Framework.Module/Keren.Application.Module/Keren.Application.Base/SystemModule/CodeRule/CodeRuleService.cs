    ...
    public class CodeRuleService : RepositoryFactory
    {
        ...
        public IEnumerable<CodeRuleEntity> GetPageList(Pagination pagination, string keyword)
        {
            try
            {
                ...
                strSql.Append(" FROM KR_Base_CodeRule t WHERE t.F_EnabledMark = 1 AND t.F_DeleteMark = 0 ");
        ...
        public bool ExistEnCode(string enCode, string keyValue)
        {
            ...
            {
                var strSql = new StringBuilder();
                strSql.Append(" SELECT t.F_RuleId FROM KR_Base_CodeRule t WHERE t.F_DeleteMark = 0 AND t.F_EnCode = @enCode ");
                if (!string.IsNullOrEmpty(keyValue))
                {
        ...
        public bool ExistFullName(string fullName, string keyValue)
        {
            ...
            {
                var strSql = new StringBuilder();
                strSql.Append(" SELECT t.F_RuleId FROM KR_Base_CodeRule t WHERE t.F_DeleteMark = 0 AND t.F_FullName = @fullName ");
                if (!string.IsNullOrEmpty(keyValue))
                {
                    strSql.Append(" AND t.F_RuleId != @keyValue  ");
                }
