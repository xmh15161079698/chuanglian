    ...
    public class ModuleService : RepositoryFactory
    {
        ...
        public IEnumerable<ModuleEntity> GetList()
        {
            try
            {
                ...
                strSql.Append("SELECT " + fieldSql + " FROM KR_Base_Module t WHERE t.F_DeleteMark = 0 Order By t.F_ParentId,t.F_SortCode ");
        ...
        public IEnumerable<ModuleButtonEntity> GetButtonList(string moduleId)
        {
            ...
            {
                StringBuilder strSql = new StringBuilder();
                strSql.Append("SELECT " + btnfieldSql + " FROM KR_Base_ModuleButton t WHERE t.F_ModuleId = @moduleId ORDER BY t.F_SortCode ");
        ...
        public IEnumerable<ModuleColumnEntity> GetColumnList(string moduleId)
        {
            ...
            {
                StringBuilder strSql = new StringBuilder();
                strSql.Append("SELECT " + colfieldSql + " FROM KR_Base_ModuleColumn t WHERE t.F_ModuleId = @moduleId ORDER BY t.F_SortCode ");
        ...
        public IEnumerable<ModuleFormEntity> GetFormList(string moduleId)
        {
            ...
            {
                StringBuilder strSql = new StringBuilder();
                strSql.Append("SELECT " + formfieldSql + " FROM KR_Base_ModuleForm t WHERE t.F_ModuleId = @moduleId ORDER BY t.F_SortCode ");
