...
namespace Keren.Application.Base.SystemModule
{
    ...
    public class ModuleBLL : ModuleIBLL
    {
        ...
        private string cacheKey = "Keren_ADMS_modules";
        private string cacheKeyBtn = "Keren_ADMS_modules_Btn_";      // + 模块主键
        private string cacheKeyColumn = "Keren_ADMS_modules_Column_";// + 模块主键
        private string cacheKeyForm = "Keren_ADMS_modules_Form_";// + 模块主键
        #endregion
        ...
        public List<TreeModel> GetButtonCheckTree()
        {
            ...
            {
                TreeModel node = new TreeModel();
                node.id = module.F_ModuleId + "_keren_moduleId";
                ...
                node.parentId = module.F_ParentId + "_keren_moduleId";
                if (module.F_Target != "expand")
                {
                    ...
                    foreach (var button in buttonList)
                    {
                        ...
                        buttonNode.parentId = (button.F_ParentId == "0" ? button.F_ModuleId + "_keren_moduleId" : button.F_ParentId);
            ...
            foreach (var module in modulelist)
            {
                ...
                if (module.F_Target != "expand")
                {
                    ...
                    foreach (var column in columnList)
                    {
                        ...
                        columnNode.parentId = column.F_ModuleId + "_keren_moduleId";
