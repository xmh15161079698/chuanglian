...
namespace Keren.Application.Base.SystemModule
{
    ...
    public class CustmerQueryBLL : CustmerQueryIBLL
    {
        ...
        private string cacheKey = "Keren_ADMS_custmerQuery_";// +功能地址 + 用户主键（可无）
        #endregion
        ...
        public string ConditionToSql(string queryJson, string formula, UserEntity userEntity)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(formula))
                {
                    ...
                    {
                        strSql = formula.Replace("" + i, "{@Keren" + i + "Keren@}");
                    }
                }
                else
                {
                ...
                foreach (var item in list)
                {
                    ...
                    strone += " ";
                    strSql.Replace("{@Keren" + num + "Keren@}", strone);
                    num++;
                }
