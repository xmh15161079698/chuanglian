    ...
    public class DataItemService : RepositoryFactory
    {
        ...
        public IEnumerable<DataItemEntity> GetClassifyList()
        {
            try
            {
                ...
                strSql.Append("SELECT " + fieldSql + " FROM KR_Base_DataItem t WHERE t.F_DeleteMark = 0 Order By t.F_ParentId,t.F_SortCode ");
        ...
        public IEnumerable<DataItemDetailEntity> GetDetailList(string itemCode)
        {
            ...
            {
                StringBuilder strSql = new StringBuilder();
                strSql.Append("SELECT " + detailFieldSql + @" FROM KR_Base_DataItemDetail t
                            INNER JOIN KR_Base_DataItem t2 ON t.F_ItemId = t2.F_ItemId
