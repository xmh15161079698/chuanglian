    ...
    public class RptRelationService : RepositoryFactory
    {
        ...
        public IEnumerable<KR_RPT_RelationEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                ...
                t.F_Description
                ");
                strSql.Append("  FROM KR_RptRelation t ");
                ...
                return this.BaseRepository().FindList<KR_RPT_RelationEntity>(strSql.ToString(), dp, pagination);
            }
            catch (Exception ex)
            {
        ...
        public KR_RPT_RelationEntity GetKR_RptRelationEntity(string keyValue)
        {
            try
            {
                return this.BaseRepository().FindEntity<KR_RPT_RelationEntity>(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            ...
            {
                //删除报表关系同时把菜单也删除
                KR_RPT_RelationEntity relation = this.BaseRepository().FindEntity<KR_RPT_RelationEntity>(keyValue);
        ...
        public void SaveEntity(string keyValue, KR_RPT_RelationEntity entity)
        {
            try
            {
                ...
                else
                {
                    ...
                    moduleEntity.F_UrlAddress = "/KR_ReportModule/RptManage/Report?reportId=" + entity.F_RptUrl;
