...
namespace Keren.Util.Operat
{
    ...
    public class OperatorHelper
    {
        ...
        private string cacheKeyOperator = "Keren_ADMS_operator_";// +登录者token
        private string cacheKeyToken = "Keren_ADMS_token_";// +登录者token
        private string cacheKeyError = "Keren_ADMS_error_";// + Mark

        private string cacheKeyInfo = "Keren_ADMS_info_";// + Mark
        /// <summary>
        /// 秘钥
        /// </summary>
        private string LoginUserToken = "Keren_ADMS_V7_Token";
        /// <summary>
        /// 标记登录的浏览器
        /// </summary>
        private string LoginUserMarkKey = "Keren_ADMS_V7_Mark";
        /// <summary>
        /// 获取实例
        /// </summary>
