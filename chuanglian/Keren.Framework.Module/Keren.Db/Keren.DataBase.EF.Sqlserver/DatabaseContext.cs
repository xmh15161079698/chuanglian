...
namespace Keren.DataBase.SqlServer
{
    /// <summary>
    ...
    public class DatabaseContext : DbContext, IDisposable, IObjectContextAdapter
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            string assembleFileName = Assembly.GetExecutingAssembly().CodeBase.Replace("Keren.DataBase.SqlServer.DLL", "Keren.Application.Mapping.DLL").Replace("file:///", "");
