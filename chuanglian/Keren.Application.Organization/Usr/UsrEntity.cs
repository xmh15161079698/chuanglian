...
namespace Keren.Application.Organization
{
    ...
    public class UsrEntity
    {
        ...
        public string F_CreateUsrId { get; set; }
        /// <summary>
        /// 创建用户
        /// </summary>	
        [Column("F_CREATEUSERNAME")]
        public string F_CreateUsrName { get; set; }
        /// <summary>
        /// 修改日期
        /// </summary>	
        [Column("F_MODIFYDATE")]
        ...
        public string F_ModifyUsrId { get; set; }
        /// <summary>
        /// 修改用户
        /// </summary>		
        [Column("F_MODIFYUSERNAME")]
        public string F_ModifyUsrName { get; set; }
        #endregion
        ...
        public void Create()
        {
            ...
            this.F_CreateUsrId = usrInfo.usrId;
            this.F_CreateUsrName = usrInfo.realName;

            this.F_UsrId = Guid.NewGuid().ToString();
        ...
        {
            UsrInfo usrInfo = LoginUsrInfo.Get();
            this.F_ModifyUsrId = usrInfo.usrId;
            this.F_ModifyUsrName = usrInfo.realName;

            this.F_UsrId = keyValue;
