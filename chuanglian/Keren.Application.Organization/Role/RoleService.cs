    ...
    public class RoleService : RepositoryFactory
    {
        ...
        public IEnumerable<RoleEntity> GetList()
        {
            try
            {
                ...
                strSql.Append(" FROM KR_Base_Role t WHERE t.F_EnabledMark = 1 AND t.F_DeleteMark = 0 ORDER BY t.F_FullName ");
        ...
        public IEnumerable<RoleEntity> GetPageList(Pagination pagination, string keyword)
        {
            try
            {
                ...
                strSql.Append("SELECT ");
                strSql.Append(fieldSql);
                strSql.Append(" FROM KR_Base_Role t WHERE t.F_EnabledMark = 1 AND t.F_DeleteMark = 0 ");
