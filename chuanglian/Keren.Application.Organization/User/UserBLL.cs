...
namespace Keren.Application.Organization
{
    ...
    public class UserBLL : UserIBLL
    {
        ...
        private string cacheKey = "Keren_ADMS_user_";       // +公司主键
        private string cacheKeyAccount = "Keren_ADMS_user_account_";// +用户账号（账号不允许改动）
        private string cacheKeyId = "Keren_ADMS_user_Id_";// +用户账号（账号不允许改动）
        #endregion
