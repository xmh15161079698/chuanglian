...
namespace Keren.Application.WebApi.Modules
{
    public class AnnexesApi : BaseApi
    {
        ...
        public Response Upload(dynamic _)
        {
            ...
            string virtualPath = string.Format("{0}/{1}/{2}/{3}{4}", filePath, userInfo.F_Id, uploadDate, fileGuid, FileEextension);
            ...
            if (!System.IO.File.Exists(virtualPath))
            {
                ...
                fileAnnexesEntity.F_CreateUserId = userInfo.F_Id;
                //fileAnnexesEntity.F_CreateUserName = userInfo.F_RealName;
