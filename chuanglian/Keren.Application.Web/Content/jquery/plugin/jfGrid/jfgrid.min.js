...
l;f++)c[f]||g.push(a.rowdatas[f]);0==g.length&&g.push({});a.rowdatas=g;e.jfGrid.renderData(b)}else top.Keren.alert.warning("\u8bf7\u9009\u62e9\u9700\u8981\u5220\u9664\u7684\u884c!")});c.append(d);c.append(f);b.append(c)}},renderStatistics:function(b){var a=b[0].dfop;if(a.isStatistics){var c=b.find("#jfgrid_footerrow_"+a.id);b=c.find("#jfgrid_statistics_"+a.id);0==b.length&&(b=e('<div class="jfgrid-statistics" id="jfgrid_statistics_'+a.id+'" ></div>'),c.append(b),b.css({width:a._headWidth+"px",left:a._leftWidth+
