...
var bootstrap = function ($, keren) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#F_Proportion1').krselect({
                placeholder: false,
                data: [{ id: '1', text: '1/1' }, { id: '2', text: '1/2' }]
            }).krselectSet('1');
            $('#F_Proportion2').krselect({
                placeholder: false,
                data: [{ id: '1', text: '1/1' }, { id: '2', text: '1/2' }]
            }).krselectSet('1');
            $('#F_Proportion3').krselect({
                placeholder: false,
                data: [{ id: '1', text: '1/1' }, { id: '2', text: '1/2' }]
            }).krselectSet('1');
            $('#F_Proportion4').krselect({
                placeholder: false,
                data: [{ id: '1', text: '1/1' }, { id: '2', text: '1/2' }]
            }).krselectSet('1');
            //图表类型
            $('#F_Type').krselect().krselectSet('1');
            //完成事件
            $("#btn_finish").click(function () {
                ...
                $.krSaveForm(top.$.rootUrl + '/KR_Desktop/DTChart/SaveForm?keyValue=' + keyValue, postData, function (res) {
