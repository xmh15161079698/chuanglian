...
var bootstrap = function ($, keren) {
    ...
    var page = {
            ...
            $('#wizard').wizard().on('change', function (e, data) {
                ...
                if (data.direction == "next") {
                    if (data.step == 1) {
                        ...
                        keren.httpAsyncPost(top.$.rootUrl + '/KR_CodeGeneratorModule/TemplatePC/LookEntityCode', postData, function (res) {
                            if (res.code == 200) {
        ...
        /*保存数据*/
        save: function () {
            $.krSaveForm(top.$.rootUrl + '/KR_CodeGeneratorModule/TemplatePC/CreateEntityCode', postData, function (res) { });
        }
    };
