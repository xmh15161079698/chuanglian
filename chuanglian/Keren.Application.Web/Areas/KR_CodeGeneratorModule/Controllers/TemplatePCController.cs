using Keren.Application.Base.CodeGeneratorModule;
...
namespace Keren.Application.Web.Areas.KR_CodeGeneratorModule.Controllers
{
    ...
    public class TemplatePCController : MvcControllerBase
    {
            ...
            foreach (var btn in colDataObj.btns)
            {
                switch (btn)
                {
                    case "add":
                        ...
                        addButtonEntity.F_EnCode = "kr_add";
                    ...
                    case "edit":
                        ...
                        editButtonEntity.F_EnCode = "kr_edit";
                    ...
                    case "delete":
                        ...
                        deleteButtonEntity.F_EnCode = "kr_delete";
                    ...
                    case "print":
                        ...
                        printButtonEntity.F_EnCode = "kr_print";
            ...
            foreach (var btn in colDataObj.btns)
            {
                switch (btn)
                {
                    ...
                    case "save":
                        ModuleButtonEntity editButtonEntity = new ModuleButtonEntity();
                        editButtonEntity.Create();
                        editButtonEntity.F_EnCode = "kr_save";
        ...
        public ActionResult CreateReportCode(string databaseLinkId, string strSql, string queryData, string colData, string baseInfo, string moduleEntityJson)
        {
            ...
            outportButtonEntity.F_EnCode = "kr_outport";
