...
namespace Keren.Application.Web.Areas.KR_SystemModule.Controllers
{
    ...
    public class WebOfficeController : MvcControllerBase
    {
        ...
        //{
        //    kr_StampManageIBLL.GetImg(keyValue);
        //    return Success("获取成功！");
        //}
        ...
        //{
        //    var data = kr_StampManageIBLL.GetList(keyword);
        //    return Success(data);
        //}
        ...
        //{
        //    var result = kr_StampManageIBLL.EqualPassword(keyValue, Password);
        //    if (result)
        //    {
