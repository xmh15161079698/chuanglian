    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#kr_add').on('click', function () {
                ...
                keren.layerForm({
                    id: 'form',
                    title: '新增',
                    url: top.$.rootUrl + '/KR_SystemModule/DbField/Form',
                    width: 450,
                    height: 300,
            ...
            $('#kr_edit').on('click', function () {
                ...
                if (keren.checkrow(keyValue)) {
                    keren.layerForm({
                        id: 'editform',
                        title: '编辑',
                        url: top.$.rootUrl + '/KR_SystemModule/DbField/Form?keyValue=' + keyValue,
                        width: 450,
                        height: 300,
                        callBack: function (id) {
                            return top[id].acceptClick(refreshGirdData);
            ...
            $('#kr_delete').on('click', function () {
                ...
                if (keren.checkrow(keyValue)) {
                    keren.layerConfirm('是否确认删除该项！', function (res) {
                        if (res) {
                            keren.deleteForm(top.$.rootUrl + '/KR_SystemModule/DbField/DeleteForm', { keyValue: keyValue }, function () {
                                refreshGirdData();
                            });
                        }
                    });
        ...
        initGrid: function () {
            $('#gridtable').krAuthorizeJfGrid({
                url: top.$.rootUrl + '/KR_SystemModule/DbField/GetPageList',
                headData: [
