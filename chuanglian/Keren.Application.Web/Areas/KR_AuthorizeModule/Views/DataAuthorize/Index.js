    ...
    var page = {
        ...
        bind: function () {
            ...
            if (!!objectId) {
                ...
                $('#kr_add').on('click', function () {
                    if (!interfaceId) {
                        keren.alert.warning('请选择左侧接口！');
                        return false;
                    }
                    keren.layerForm({
                        id: 'form',
                        title: '新增数据权限',
                        url: top.$.rootUrl + '/KR_AuthorizeModule/DataAuthorize/Form?interfaceId=' + interfaceId + '&objectId=' + objectId + '&objectType=' + objectType + '&type=1',
                        width: 700,
                        height: 400,
            ...
            $('#kr_edit').on('click', function () {
                ...
                if (keren.checkrow(keyValue)) {
                    keren.layerForm({
                        id: 'form',
                        title: '编辑数据权限',
                        url: top.$.rootUrl + '/KR_AuthorizeModule/DataAuthorize/Form?interfaceId=' + interfaceId + '&objectId=' + objectId + '&objectType=' + objectType + '&keyValue=' + keyValue + '&type=1',
                        width: 700,
                        height: 400,
                        callBack: function (id) {
                            return top[id].acceptClick(refreshGirdData);
            ...
            /*接口管理*/
            $('#kr_interface').on('click', function () {
                keren.layerForm({
                    id: 'InterfaceIndex',
                    title: '接口管理',
                    url: top.$.rootUrl + '/KR_SystemModule/Interface/Index',
                    width: 800,
                    height: 500,
                    maxmin: true,
                    btn: null,
        ...
        inittree: function () {
            $('#interface_tree').krtree({
                url: top.$.rootUrl + '/KR_SystemModule/Interface/GetTree',
        ...
        initGrid: function () {
            $('#gridtable').krAuthorizeJfGrid({
                url: top.$.rootUrl + '/KR_AuthorizeModule/DataAuthorize/GetRelationPageList?type=1',
                headData: [
