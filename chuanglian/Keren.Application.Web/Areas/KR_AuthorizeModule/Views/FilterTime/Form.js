...
var bootstrap = function ($, keren) {
    ...
    var page = {
        ...
        initData: function () {
            $.krSetForm(top.$.rootUrl + '/KR_AuthorizeModule/FilterTime/GetFormData?keyValue=' + objectId, function (data) {
                var formdata = data || {};
    ...
    acceptClick = function () {
        ...
        $.krSaveForm(top.$.rootUrl + '/KR_AuthorizeModule/FilterTime/SaveForm', postData, function (res) { });
