        ...
        bind: function () {
            ...
            keren.clientdata.getAllAsync('sourceData', {
                ...
                callback: function (_data) {
                    var treeData = $.krtree.listTotree(_data, op.treeParentId, op.treeValueId, op.treeTextId, op.treeValueId, false);
                    $('#tree').krtree({
                        data: treeData,
            ...
            $('.selected-item-list-warp').krscroll();
