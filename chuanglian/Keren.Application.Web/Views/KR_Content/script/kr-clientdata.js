...
(function ($, keren) {
    ...
    clientDataFn.modules = {
        ...
        init: function () {
            ...
            keren.httpAsyncGet($.rootUrl + '/KR_SystemModule/Module/GetModuleList', function (res) {
    ...
    clientDataFn.userinfo = {
        ...
        init: function () {
            ...
            keren.httpAsyncGet($.rootUrl + '/Login/GetUserInfo', function (res) {
                if (res.code == keren.httpCode.success) {
    ...
    clientAsyncData.company = {
        ...
        init: function () {
            if (clientAsyncData.company.states == loadSate.no) {
                ...
                keren.httpAsync('GET', top.$.rootUrl + '/KR_OrganizationModule/Company/GetMap', { ver: ver }, function (data) {
                    if (!data) {
    ...
    clientAsyncData.department = {
        ...
        init: function () {
            if (clientAsyncData.department.states == loadSate.no) {
                ...
                keren.httpAsync('GET', top.$.rootUrl + '/KR_OrganizationModule/Department/GetMap', { ver: ver }, function (data) {
                    if (!data) {
    ...
    clientAsyncData.user = {
        ...
        init: function () {
            if (clientAsyncData.user.states == loadSate.no) {
                ...
                keren.httpAsync('GET', top.$.rootUrl + '/KR_OrganizationModule/User/GetMap', { ver: ver }, function (data) {
                    if (!data) {
    ...
    clientAsyncData.dataItem = {
        ...
        init: function () {
            if (clientAsyncData.dataItem.states == loadSate.no) {
                ...
                keren.httpAsync('GET', top.$.rootUrl + '/KR_SystemModule/DataItem/GetMap', { ver: ver }, function (data) {
                    if (!data) {
        ...
        get: function (op) {
            ...
            if (clientAsyncData.dataItem.states == loadSate.ing) {
                ...
                if (_item) {
                    top.keren.language.get(_item.text, function (text) {
                        _item.text = text;
        ...
        getAll: function (op) {
            ...
            if (clientAsyncData.dataItem.states == loadSate.ing) {
                ...
                $.each(data[op.code] || {}, function (_index, _item) {
                    _item.text = top.keren.language.getSyn(_item.text);
                    res[_index] = _item;
                });
    ...
    clientAsyncData.db = {
        ...
        init: function () {
            if (clientAsyncData.db.states == loadSate.no) {
                ...
                keren.httpAsync('GET', top.$.rootUrl + '/KR_SystemModule/DatabaseLink/GetMap', { ver: ver }, function (data) {
                    if (!data) {
    ...
    clientAsyncData.sourceData = {
        ...
        load: function (code) {
            ...
            keren.httpAsync('GET', top.$.rootUrl + '/KR_SystemModule/DataSource/GetMap', { code: code, ver: ver }, function (data) {
                if (!data) {
    ...
    clientAsyncData.custmerData = {
        ...
        load: function (url) {
            keren.httpAsync('GET', top.$.rootUrl + url, {}, function (data) {
                if (!!data) {
                    clientData[url] = data;
                }
    ...
    clientAsyncData.desktop = {
        ...
        init: function () {
            if (clientAsyncData.desktop.states == loadSate.no) {
                ...
                keren.httpAsync('GET', top.$.rootUrl + '/KR_Desktop/DTTarget/GetMap', { ver: ver }, function (data) {
                    if (!data) {
