...
(function ($, keren) {
    ...
    $.extend(keren, {
        ...
        getDate: function (format, strInterval, Number) {
            ...
            var res = keren.formatDate(myDate, format);
            return res;
        },
        // 月
        getMonth:function(){
            ...
            var currentDate = keren.parseDate(keren.formatDate(new Date(), "yyyy-MM-01"));
            var endDate = currentDate.DateAdd('m', 1).DateAdd('d', -1);

            res.begin = keren.formatDate(currentDate, 'yyyy-MM-dd 00:00:00');
            res.end = keren.formatDate(endDate, 'yyyy-MM-dd 23:59:59');
        ...
        getPreMonth: function () {
            ...
            res.begin = keren.formatDate(preMonth, 'yyyy-MM-01 00:00:00');
            res.end = keren.formatDate(preMonth, 'yyyy-MM-dd 23:59:59');
        ...
        getCurrentQuarter: function () {
            ...
            return keren.getQuarter(currentDate.getFullYear(), currentDate.getMonth());
        },
    ...
    Date.prototype.MaxDayOfDate = function () {
        var myDate = this;
        var date1 = keren.parseDate(keren.formatDate(myDate, 'yyyy-MM-01 00:00:00'));
