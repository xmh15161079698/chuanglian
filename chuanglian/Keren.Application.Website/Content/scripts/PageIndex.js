    ...
    httpGet($.rootUrl + '/Home/GetAllList', function (res) {
        ...
        if (res && res.code == 200) {
            $.each(res.data, function (_index, _item) {
                switch (_item.F_Type) {
                    case '1':// 顶部文字
                        $('#kr_site_top_text').text(_item.F_Name);
                        break;
                    case '2':// 底部文字
                ...
                case '1': // 文章列表
                    $container.append('<div class="lr-site-body-right">\
                                           ...
                                           <div class="lr-site-body-cotent">\
                                               <div class="lr-site-body-list" id="kr_body_cotent">\
                                               </div>\
                                               <div class="lr-site-body-page" id="kr_page"></div>\
                                           </div>\
                                       </div>');
                    break;
                case '2': // 图片列表
                    $container.append('<div class="lr-site-body-right">\
                                           <div class="lr-site-title right-title">未选择分类项</div>\
                                           <div class="lr-site-body-cotent">\
                                               <div class="row" id="kr_body_cotent">\
                                               </div>\
                                               <div class="lr-site-body-page" id="kr_page"></div>\
                                           </div>\
                                       </div>');
